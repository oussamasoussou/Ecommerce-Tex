            ...
            <div class="row row-cols-md-2 row-cols-1  align-items-center">
                <div class="col">
                    <div class="image__with--text__thumbnail">
                        <img class="display-block" src="{{$prop->img}}" alt="drone-image">
                    </div>
                </div>
                <div class="col">
    ...
    <section class="blog__section blog__section--bg section--padding">
        <div class="container">
            <div class="section__heading text-center mb-50">
                <h2 class="section__heading--maintitle text__secondary mb-10">NOS MEILLEURS OFFRES</h2> 
            </div>
                        ...
                        <article class="blog__card">
                            <div class="blog__card--thumbnail">
                                <a class="blog__card--thumbnail__link display-block" href="{{url('details-produit/'.$prod->id)}}">
                                    <img class="blog__card--thumbnail__img display-block" src="{{$prod->img->first()->img}}" alt="blog-img">
                                </a>
                            </div>
                            <div class="blog__card--content">
                                <ul class="blog__card--meta d-flex justify-content-center">
                                    <li class="blog__card--meta__text text__secondary" style ="color: black; text-shadow: 2px 1px 2px #cbd5d6;">
                                        {{$prod->lib}}
                                        <br> 
