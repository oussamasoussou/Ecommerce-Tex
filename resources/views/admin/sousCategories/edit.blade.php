        ...
        <div class="row">
                    ...
                    <div class="card-body">
                        <form class="forms-sample" action="{{ url('update-categorie/'.$categorie->id) }}" method="POST" >
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" disabled="disabled" class="form-control" id="exampleInputName1" value="{{ $categorie->lib }}" name="lib">
                            </div>  
            ...
            <div class="col-md-6">
                <div class="card">
                    ...
                    <div class="card-body">
                        <form class="forms-sample" action="{{ url('update-sous-categorie/'.$sous_categorie->id) }}" method="POST">
                            @csrf
                            <div class="form-group">
                                <label for="exampleInputName1">Titre</label>
                                <input type="text" class="form-control" id="exampleInputName1" placeholder="Name" name="lib">
                            </div>
