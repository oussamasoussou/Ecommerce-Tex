...
@section('content')
 ...
 <div class="main-content">
    <div class="container-fluid"> 
        <div class="card-header"><h3>Ajouter couleur</h3></div> 
        <div class="row">
            <div class="col-md-12">
                <div class="card">
                    <div class="card-body">
                        <form class="forms-sample" action="{{ url('update-couleur/'.$couleur->id) }}" method="POST" enctype="multipart/form-data">
                            @csrf 
                            @method('PUT')
                            <div class="form-group">
                                <label for="exampleInputName1">Code</label>
                                <input type="text" class="form-control" id="exampleInputName1" value="{{ $couleur->code }}" name="code" required>
                            </div>
                            <div class="form-group">
                                <label for="exampleInputName1">Nom couleur</label>
                                <input type="text" class="form-control" id="exampleInputName1" value="{{ $couleur->nom }}" name="nom">
                            </div>
